...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      Recevez les dernières nouvelles et mises à jour directement dans votre boîte de réception. Ne manquez rien en vous inscrivant dès maintenant !
      </p>
      <div>
        <input
          type="text"
        ...
        Aucun spam garanti, alors ne nous envoyez pas de courriers indésirables.
        </p>
      </div>
