      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 text-center mb-8">
            <h2 className="text-3xl font-bold text-blue-600">Nos Partenaires</h2>
          </div>
...
const SingleBrand = ({ brand }: { brand: Brand }) => {
  ...
  return (
    <div className="flex w-full items-center justify-center px-6 py-6 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/6">
      <a
        href={href}
        target="_blank"
